...
@interface OASGetLocationOperation (/* Private stuff here */)
...
@implementation OASGetLocationOperation
@synthesize applId;
@synthesize applKey;
...
- (OASGetLocationOperation *)initWithApplId:(NSNumber *)anApplId applKey:(NSString *)anApplKey requestId:(NSString *)aRequestId
